...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-todo-keywords
        '((sequence "TODO(t)" "|" "DONE(d)" "CNCL(c)") ;; a thing I need to do
          (sequence "NEXT(n)" "|" "DONE(d)" "CNCL(c)") ;; next thing to do in a project
          (sequence "DELG(D)" "|" "DONE(d)")           ;; a thing someone else needs to do
          (sequence "MAYB(m)" "|" "CNCL(c)")))         ;; not sure whether it needs to be done
  ...
  (setq org-agenda-custom-commands
        '(("h" "Work todos" tags-todo
           "-personal-doat={.+}-dowith={.+}/!-DELG"
           ((org-agenda-todo-ignore-scheduled t)))
          ("H" "All work todos" tags-todo "-personal/!-DELG-MAYB"
           ((org-agenda-todo-ignore-scheduled nil)))
          ("A" "Work todos with doat or dowith" tags-todo
           "-personal+doat={.+}|dowith={.+}/!-DELG"
           ((org-agenda-todo-ignore-scheduled nil)))
          ("j" "TODO dowith and DELG with"
           ((org-sec-with-view "TODO dowith")
            (org-sec-where-view "TODO doat")
            (org-sec-assigned-with-view "DELG with")
            (org-sec-stuck-with-view "STUCK with")))
          ("J" "Interactive TODO dowith and DELG with"
